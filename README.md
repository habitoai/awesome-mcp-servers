...
- [Roundtable](https://github.com/whateverneveranywhere/roundtable-dashboard) - Multi-model AI debate platform — consult GPT-4o, Claude, Gemini & 200+ models that discuss your problem, then synthesize a unified insight. Tools: consult, review_code, debug, architect, plan_implementation, assess_tradeoffs.
