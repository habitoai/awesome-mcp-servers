...
- [Roundtable](https://github.com/sinaneshat/roundtable-dashboard) - Multi-model AI debate platform — consult GPT-4o, Claude, Gemini & 200+ models that discuss your problem, then synthesize a unified insight. Tools: consult_council, review_code, debug_issue, design_architecture, plan_implementation, assess_tradeoffs.
