...
- [Bavimail](https://github.com/Bavlio/bavimail-mcp-server) - Send, receive, and manage email for AI agents: provision inboxes and domains, reply in-thread, and track delivery via the Bavimail email API (12 tools, stdio).
