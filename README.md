...
- [SeqBench](https://seqbench.com/api/mcp) - Molecular biology MCP server for primer design, cloning simulation, CRISPR guide RNA design, and batch sequence workflows, with stateful sessions for AI agents
